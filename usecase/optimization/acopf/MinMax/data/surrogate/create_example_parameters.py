...
def create_example_parameters(n_buses: int):
    ...
    * training procedure
    ...
    try:
        ...
        # Yf and Yt are crucial for calculating branch power/current flows in AC. 	- Ibr = ybr @ IM @ Volt 
    ...
    true_system_parameters = {'Sg_delta': Sg_delta,
                              ...
                              'Yf_rect': Yf_rect,     # Placeholder/requires specific AC derivation
                              'Yt_rect': Yt_rect,     # Placeholder/requires specific AC derivation
                              'Map_g': Map_g,
                              'Map_L': Map_L,
    ...
    # -----------------------------------------------------------------------------------------------
    n_data_points = 25_000
    n_test_data_points = 5_000
    ...
    simulation_parameters = {'true_system': true_system_parameters,
                             ...
                             'net_object': ppc, 
                             'nn_output': 'surrogate_i'} # 'pg_vm', 'pg_qg', 'vr_vi', 'surrogate_s', , 'surrogate_i'
