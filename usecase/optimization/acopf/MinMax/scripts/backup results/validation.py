...
def main(only_violations):  
    ...
    if only_violations == False:
        ...
        print(
            ...
            f"Power NN true {num_solves - int(np.sum(power_nn_results_true['pf_convergence']))} out of {num_solves},\n"
            f"Power NN false {num_solves - int(np.sum(power_nn_results_false['pf_convergence']))} out of {num_solves},\n"
